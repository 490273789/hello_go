...
func readFile() {
	// 打开文件
	file, err := os.Open("/Users/wangshaonan/code/go/go-base/file/test.txt")
	if err != nil {
...
func fileStream1() {
	...
	content, err := os.ReadFile("/Users/wangshaonan/code/go/go-base/file/test.txt")
	if err != nil {
		println("文件读取错误：", err)
	}
...
func fileStream2() {
	file, err := os.Open("/Users/wangshaonan/code/go/go-base/file/test1.txt")
	if err != nil {
		fmt.Println("文件打开错误：", err)
	}
	//defer file.Close()
